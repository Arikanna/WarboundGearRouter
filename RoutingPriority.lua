...
function WGRRemoveCharacter(characterName)
    ...
    if WarboundGearRouterDB.mailGearTracking then
        WarboundGearRouterDB.mailGearTracking[key] = nil
    end
    ...
    if WarboundGearRouterDB.ownedTrinketComponents then
        WarboundGearRouterDB.ownedTrinketComponents[key] = nil
    end
